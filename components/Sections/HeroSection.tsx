        ...
        <div className="hero__split">
          <div>
            ...
            <h2 className="hero__subtitle">
              Купить метафорические карты (МАК): авторские электронные колоды для психологов и для себя
            </h2>
            <p className="hero__text">
              Электронные метафорические ассоциативные карты — психологический инструмент, а не эзотерика.
              Не нужно ждать доставку: оплатили онлайн — колода МАК открывается прямо в телефоне через
              пару минут.
            </p>
          </div>
